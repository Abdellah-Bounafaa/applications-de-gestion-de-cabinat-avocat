...
<div class="card">
                                    ...
                                    <div class="card-header"><h3> Gestion Huissier</h3>
       ...
       <div class="card">
                                    ...
                                    <div class="card-body table-responsive">
                                            <table id="simpletable" class="table table-bordered nowrap">
                                                ...
                                                <tr>
                                                    <td><button data-role="update" class="btn-icon btn-outline-success" data-toggle="modal" data-target="#edition" data-id_huissier="{{$row->ID_HUISSIER}}" data-prenom="{{$row->PRENOM}}" data-nom="{{$row->NOM}}" data-email="{{$row->EMAIL}}" data-adresse="{{$row->ADRESS}}" data-tel="{{$row->TELEPHONE}}" data-login="{{$row->LOGIN}}"><i class="ik ik-edit"></i></button></td>
