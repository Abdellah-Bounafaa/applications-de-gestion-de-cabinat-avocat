                                ...
                                @foreach ($adversaire as $row)
                                    <tr>
                                        <td><button data-role="update" class="btn-icon btn-outline-success"
                                                ...
                                                data-caution="{{ $row->CAUTION }}" data-mobile="{{ $row->MOBILE }}"
                                                data-email="{{ $row->EMAIL }}"><i class="ik ik-edit"></i></button></td>
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#caution_modifier').html(
                            '<div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm">Nom_Cautionnaire : </label><input type="text" class="form-control form-control-sm" placeholder="Nom cautionnaire" id="nom_caution" value="' +
                            data.NOM +
                            '" required></div></div><div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm">Prenom_Cautionnaire : </label><input type="text" class="form-control form-control-sm" placeholder="Nom cautionnaire" id="prenom_caution" value="' +
                            data.PRENOM +
                            '" required></div></div><div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm">TEL_Cautionnaire : </label><input type="text" class="form-control form-control-sm" placeholder="Nom cautionnaire" id="tel_caution" value="' +
                            data.TEL +
                            '" required></div></div><div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm">Identifiant_Cautionnaire : </label><input type="text" class="form-control form-control-sm" placeholder="Nom cautionnaire" id="identifiant_caution" value="' +
                            data.IDENTIFIANT +
        ...
        $(document).on('click', 'button[data-role=sauvegarder]', function() {
            ...
            if (caution == 0) {
                ...
                fruits = [identifiant, nom, prenom, tel, adresse, ville, caution, type, id, adresse1, adresse2,
                    adresse3, nom_cautionnaire, prenom_cautionnaire, identifiant_cautionnaire, tel_cautionnaire,
                    type_cautionnaire, adresse_cautionnaire
                ];
