...
<title>@yield('title')Gestion Adversaire</title>
...
<div class="card">
                                    ...
                                    <div class="card-header"><h3> Gestion Adversaire</h3>
       ...
       <div class="card">
                                    ...
                                    <div class="card-body table-responsive">
                                            <table id="simpletable" class="table table-bordered nowrap">
                                                ...
                                                <tr>
                                                     <td><button data-role="update" class="btn-icon btn-outline-success" data-toggle="modal" data-target="#edition" data-id="{{$row->ID_ADVERSAIRE}}" data-identifiant="{{$row->IDENTIFIANT}}" data-creation="{{$row->DATE_CLT}}" data-nom="{{$row->NOM}}" data-prenom="{{$row->PRENOM}}" data-ville="{{$row->ID_VILLE}}" data-type="{{$row->ID_TYPET}}" data-adresse="{{$row->ADRESSE}}" data-adresse1="{{$row->ADRESSE1}}" data-adresse2="{{$row->ADRESSE2}}" data-adresse3="{{$row->ADRESSE3}}" data-tel="{{$row->TEL}}" data-caution="{{$row->CAUTION}}"  data-mobile="{{$row->MOBILE}}" data-email="{{$row->EMAIL}}"><i class="ik ik-edit"></i></button></td>
                                                    ...
                                                    <td>{{$row->TEL}}</td>
                                                    <td>@if($row->CAUTION==0)<span class="badge badge-info">Non</span>@else <span class="badge badge-info">Oui</span>@endif</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
...
@endif
     ...
     $(document).on('click','button[data-role=adressehide]',function(){
         ...
         $('button[data-role=adresse]').show();
            ...
            $(this).html('<button data-role="adresse" type="button" class="btn btn-outline-primary btn-icon"><i class="ik ik-plus"></i></button>');
    ...
    $(document).on('click','button[data-role=modadresse]',function(){
     ...
     $(document).on('click','button[data-role=modadressehide]',function(){
         ...
         $('button[data-role=modadresse]').show();
            ...
            $(this).html('<button data-role="modadresse" type="button" class="btn btn-outline-primary btn-icon"><i class="ik ik-plus"></i></button>');
    ...
    $(document).on('click','button[data-role=update]',function(){
        ...
        if(caution==1){
             ...
             success:function(data){
                 ...
                 $('#caution_modifier').html('<div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm">Nom_Cautionnaire : </label><input type="text" class="form-control form-control-sm" placeholder="Nom cautionnaire" id="nom_caution" value="'+data.NOM+'" required></div></div><div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm">Prenom_Cautionnaire : </label><input type="text" class="form-control form-control-sm" placeholder="Nom cautionnaire" id="prenom_caution" value="'+data.PRENOM+'" required></div></div><div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm">TEL_Cautionnaire : </label><input type="text" class="form-control form-control-sm" placeholder="Nom cautionnaire" id="tel_caution" value="'+data.TEL+'" required></div></div><div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm">Identifiant_Cautionnaire : </label><input type="text" class="form-control form-control-sm" placeholder="Nom cautionnaire" id="identifiant_caution" value="'+data.IDENTIFIANT+'" required></div></div><div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm" >Type_Cautionnaire : </label><select class="form-control form-control-sm" id="type_caution"  required>@foreach($type as $typet)<option value="{{$typet->ID_TYPET}}">{{$typet->LIBELLE_TYPET}}</option>@endforeach</select></div></div><div class="col-md-4"><div class="form-group"><label class="col-form-label col-form-label-sm" >Adresse_Cautionnaire : </label><input type="text" value="'+data.ADRESSE+'" class="form-control form-control-sm" id="adresse_caution"/required></div></div>'); 
    ...
    //sauvegarder
     ...
     $(document).on('click','button[data-role=sauvegarder]',function(){
        ...
        var type                = $('#type').val();
         ...
         fruits   = [identifiant,nom,prenom,tel,adresse,ville,caution,type,id,adresse1,adresse2,adresse3];
    ...
    $.toast({
      ...
      position: 'top-center'
         ...
         fruits   = [identifiant,nom,prenom,tel,adresse,ville,caution,type,id,adresse1,adresse2,adresse3,nom_cautionnaire,prenom_cautionnaire,identifiant_cautionnaire,tel_cautionnaire,type_cautionnaire,adresse_cautionnaire];
