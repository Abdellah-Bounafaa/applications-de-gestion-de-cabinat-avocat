...
CREATE TABLE `clients` (
  ...
  `CAPITALE` float(8,2) DEFAULT NULL,
...
CREATE TABLE `currateur` (
  ...
  `ID_DOSSIER` int(11) NOT NULL,
  `ID_PROCEDURE` int(11) NOT NULL,
  `REF_TRIBUNALE` char(254) DEFAULT NULL,
...
CREATE TABLE `dossier` (
  ...
  `MNT_CREANCE` float(8,2) DEFAULT NULL,
...
CREATE TABLE `requete` (
  ...
  `ID_DOSSIER` int(11) NOT NULL,
  `ID_PROCEDURE` int(11) NOT NULL,
  `REFERANCE_TRIBUNALE` varchar(254) DEFAULT NULL,
  `OBSERVATION` text DEFAULT NULL,
  `DATE_DEPOT` date DEFAULT NULL,
...
CREATE TABLE `saisie` (
  ...
  `ID_DOSSIER` int(11) NOT NULL,
  `ID_PROCEDURE` int(11) NOT NULL,
  `REF_TRUBUNAL_EXE` int(11) DEFAULT NULL,
  `DATE_DEPOT` date DEFAULT NULL,
  `DATE_RETRAIT` date DEFAULT NULL,
  `DATE_EXCECUTION` datetime DEFAULT NULL,
  `SORT` varchar(254) DEFAULT NULL,
  `PJ` text DEFAULT NULL,
  `DATE8DEMANDE` date DEFAULT NULL,
...
Alter table audiance
add COLUMN ref_tribunal char(254) DEFAULT NULL after `ID_AUDIANCE`;
Alter table audiance
