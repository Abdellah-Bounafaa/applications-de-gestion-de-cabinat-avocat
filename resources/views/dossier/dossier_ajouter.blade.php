                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label class="col-form-label col-form-label-sm">Montant_Créance : </label>

                                        <div class="input-group">
                                            <input type="text" placeholder="montant creance" id="creance"
                                                name="creance" class="form-control" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label class="col-form-label col-form-label-sm">Nature_Dossier : </label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label col-form-label-sm">Type_Dossier : </label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <label class="col-form-label col-form-label-sm">Date_Ouverture : </label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <label class="col-form-label col-form-label-sm">Gestion_Utilisateur : </label>
