...
Route::middleware(['auth'])->group(
    function () {
        ...
        Route::get('/dossier/ajouter', [DossierController::class, 'index']);
        Route::post('/dossier/ajouter/nouveau', [DossierController::class, 'nouveau']);


        //Dossier/maj

        Route::get('/dossier/search', [MajdossierController::class, 'index']);
